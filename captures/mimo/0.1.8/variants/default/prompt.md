...
<available_skills>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.8/skills/arxiv/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.8/skills/data-analytics/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.8/skills/deep-research/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.8/skills/design-blueprint/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.8/skills/docx-official/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.8/skills/drive-mimo/SKILL.md</location>
  </skill>
  <skill>
    <name>evolve</name>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.8/skills/evolve/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.8/skills/frontend-design/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.8/skills/html-to-video-pipeline/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.8/skills/learn-everything/SKILL.md</location>
  </skill>
  <skill>
    <name>loop</name>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.8/skills/loop/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.8/skills/mimocode-docs/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.8/skills/modern-python-toolchain/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.8/skills/pdf-official/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.8/skills/pptx-official/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.8/skills/product-design/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.8/skills/research-paper-writing/SKILL.md</location>
  </skill>
  <skill>
    <name>sales</name>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.8/skills/sales/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.8/skills/skill-creator/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.8/skills/super-research/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.8/skills/xlsx-official/SKILL.md</location>
  </skill>
</available_skills>
...
- **mimocode-docs**: Use whenever the user asks about MiMoCode itself: features, TUI or CLI commands, configuration, file locations, providers, models, authentication, or custom OpenAI-compatible or Anthropic-compatible API endpoints. Especially trigger when a prompt supplies or asks to configure a base URL/baseURL, API key/apiKey, model name or ID, provider, Anthropic Messages API, or global/project mimocode.json/jsonc. Use this skill to inspect existing config safely, make minimal changes, and verify them without guessing schema fields or model capabilities.
...
```json
{
  ...
  "properties": {
    ...
    "args": {
      "description": "(only when operation=\"run\") (optional) Input value exposed to the script as the global `args`, verbatim. Pass objects/arrays as ACTUAL JSON values — NOT as a JSON string. e.g. args: { theme: \"...\", signals: { trademark: \"required\" } }, never args: \"{ \\\"theme\\\": ... }\"."
    },
    "workspace": {
