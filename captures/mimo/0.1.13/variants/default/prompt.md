...
- Session checkpoint at `$PHISTORY_HOME/.local/share/mimocode/memory/sessions/ses_-ffe5fe621d3fcffeCXZE1NCVT/checkpoint.md` — current session's structured state, written ONLY by the checkpoint-writer subagent. 11 sections covering active intent, next action, directives, task tree, current work, files, learnings, errors, live resources, design decisions, and open notes. Task content lives inside §4 Task tree and §5 Current work.
- Per-task progress at `$PHISTORY_HOME/.local/share/mimocode/memory/sessions/ses_-ffe5fe621d3fcffeCXZE1NCVT/tasks/<id>/progress.md` — writer-derived splitover from session-level progress.md (not LLM-written). When you spawn a subagent on a task, the subagent may be handed this path for reading; you do not maintain it.
...
You have a single legal scratchpad at `$PHISTORY_HOME/.local/share/mimocode/memory/sessions/ses_-ffe5fe621d3fcffeCXZE1NCVT/notes.md`. Append entries to it when you want to record:
...
<available_skills>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/arxiv/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/compose-next/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/data-analytics/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/deep-research/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/design-blueprint/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/docx-official/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/drive-mimo/SKILL.md</location>
  </skill>
  <skill>
    <name>evolve</name>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/evolve/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/frontend-design/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/grok-build/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/html-to-video-pipeline/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/learn-everything/SKILL.md</location>
  </skill>
  <skill>
    <name>loop</name>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/loop/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/memory-search/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/mimocode-docs/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/modern-python-toolchain/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/pdf-official/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/playwright/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/pptx-official/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/product-design/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/research-paper-writing/SKILL.md</location>
  </skill>
  <skill>
    <name>sales</name>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/sales/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/skill-creator/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/super-research/SKILL.md</location>
  </skill>
  <skill>
    ...
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.13/skills/xlsx-official/SKILL.md</location>
  </skill>
</available_skills>
</system-reminder>
