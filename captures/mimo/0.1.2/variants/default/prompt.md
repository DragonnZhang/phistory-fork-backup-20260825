...
<available_skills>
  <skill>
    <name>self-extend</name>
    <description>Use when you want to evolve your own capabilities — create new tools to avoid repeating patterns, add hooks to improve your own behavior, build skills to accumulate domain knowledge, or override built-in tools to adapt to project needs. This is your self-iteration interface.</description>
    <location>file://$PHISTORY_HOME/.local/share/mimocode/builtin_skills/0.1.2/skills/self-extend/SKILL.md</location>
  </skill>
</available_skills>
...
#### Available Skills
- **self-extend**: Use when you want to evolve your own capabilities — create new tools to avoid repeating patterns, add hooks to improve your own behavior, build skills to accumulate domain knowledge, or override built-in tools to adapt to project needs. This is your self-iteration interface.
