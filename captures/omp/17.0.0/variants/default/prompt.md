...
Today is 2026-07-15, and the current working directory is '$PHISTORY_WORKSPACE'.
...
agent(prompt, agent?="task", model?=None, schema?=None, handle?=False) → str | dict
    JS: agent(prompt, { agent, schema, handle }).
