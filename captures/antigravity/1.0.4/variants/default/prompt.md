  ...
  "properties": {
    "ArtifactMetadata": {
      ...
      "properties": {
        "ArtifactType": {
          "type": "STRING",
          "description": "Type of artifact: 'implementation_plan', 'walkthrough', 'task', or 'other'. Use 'other' when the artifact type doesn't fit the first three categories.",
          "enum": [
            "implementation_plan",
            "walkthrough",
            "task",
...
- Omit StartLine and EndLine to view the first 800 lines of the file. If the file is smaller than 800 lines, then the whole file will be shown
...
```json
{
  ...
  "properties": {
    "ArtifactMetadata": {
      "type": "OBJECT",
      "description": "Metadata for the artifact, required when IsArtifact is true.",
      "properties": {
        "ArtifactType": {
          "type": "STRING",
          "description": "Type of artifact: 'implementation_plan', 'walkthrough', 'task', or 'other'. Use 'other' when the artifact type doesn't fit the first three categories.",
