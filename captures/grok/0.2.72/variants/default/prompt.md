...
Usage notes:
- Pass task_ids with one or more ids from background=true commands or background=true subagents; for a single task use a one-element array. Multiple ids with a positive timeout_ms wait until all complete
