...
x-anthropic-billing-header: cc_version=2.1.235.b52; cc_entrypoint=cli;
...
```json
{
  ...
  "properties": {
    ...
    "out_dir": {
      "description": "read_asset only: directory to save the file into (default: the working directory). The file is named by the asset id plus the extension for its type.",
      "type": "string",
      "maxLength": 4096
    },
    "after": {
