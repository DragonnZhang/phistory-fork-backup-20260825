...
x-anthropic-billing-header: cc_version=2.1.236.5fe; cc_entrypoint=cli;
...
```json
{
  ...
  "properties": {
    ...
    "data": {
      "description": "Document fields to write, as a JSON object. db_op 'set' (replaces the document) and 'update' (merges into it) take exactly one of `data` or `file_path`; not accepted with any other db_op.",
      "type": "object",
      "propertyNames": {
        "type": "string"
      },
