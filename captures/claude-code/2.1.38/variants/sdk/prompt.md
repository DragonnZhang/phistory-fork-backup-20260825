...
x-anthropic-billing-header: cc_version=2.1.38.c84; cc_entrypoint=sdk-cli; cch=<normalized>;
...
IMPORTANT - Use the correct year in search queries:
  - Today's date is $PHISTORY_DATE. You MUST use this year when searching for recent information, documentation, or current events.
