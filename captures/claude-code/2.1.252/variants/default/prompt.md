...
x-anthropic-billing-header: cc_version=2.1.252.39c; cc_entrypoint=cli;
...
```json
{
  ...
  "properties": {
    ...
    "note": {
      "description": "publish only: what changed in this version — a few sentences on what is new or reworked, shown beside `label` in the version picker. Optional; leave it out when nothing is worth noting.",
      "type": "string",
      "maxLength": 2000
    },
    "url": {
