...
<available_skills>
  ...
  <skill>
    ...
    <version>sha256:952a14ac4b441fc4</version>
  </skill>
  <skill>
    <name>github</name>
...
## Runtime
Runtime: agent=main | session=agent:main:main | sessionId=e4a87e1d-8b60-4385-a842-88007e92badd | host=runnervm1li68 | repo=$PHISTORY_HOME/.openclaw/workspace | os=Linux 6.17.0-1018-azure (x64) | node=v24.16.0 | model=phistory/phistory-dummy | default_model=phistory/phistory-dummy | shell=bash | thinking=off
...
[Tue 2026-06-16 17:36 UTC] Reply with one short sentence.
