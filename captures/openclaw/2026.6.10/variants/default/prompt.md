...
## Runtime
Runtime: agent=main | session=agent:main:main | sessionId=e2b1ba08-1ed3-48cb-b311-afdbf9ab319b | host=runnervm7b5n9 | repo=$PHISTORY_HOME/.openclaw/workspace | os=Linux 6.17.0-1018-azure (x64) | node=v24.18.0 | model=phistory/phistory-dummy | default_model=phistory/phistory-dummy | shell=bash | thinking=off
