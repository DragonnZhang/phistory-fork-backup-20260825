...
<available_skills>
  <skill>
    ...
    <version>sha256:c24be5084b5d93ea</version>
  </skill>
  <skill>
    <name>canvas</name>
...
## Runtime
Runtime: agent=main | host=runnervm1li68 | repo=$PHISTORY_HOME/.openclaw/workspace | os=Linux 6.17.0-1018-azure (x64) | node=v24.16.0 | model=phistory/phistory-dummy | default_model=phistory/phistory-dummy | shell=bash | thinking=off
...
[Fri 2026-06-12 15:51 UTC] Reply with one short sentence.
