...
- If multiple channels are configured, pass `channel` (feishu|nostr|msteams|nextcloud-talk|bluebubbles|zalo|zalouser|discord|qqbot|whatsapp).
...
```json
{
  ...
  "properties": {
    ...
    "size": {
      "description": "Optional size hint like 1024x1024, 1536x1024, 1024x1536, 1024x1792, or 1792x1024.",
      "type": "string"
    },
    "aspectRatio": {
...
List visible sessions with optional filters for kind, recent activity, and last messages. Use this to discover a target session before calling sessions_history or sessions_send.
