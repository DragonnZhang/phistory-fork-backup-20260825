...
- skill-creator: Create or update a Codex skill with appropriately scoped instructions and any needed supporting resources. (file: $PHISTORY_HOME/.codex/skills/.system/skill-creator/SKILL.md)
